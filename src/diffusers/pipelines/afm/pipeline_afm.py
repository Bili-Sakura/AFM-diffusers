...
from ...models.afm.generator import Generator
from ...models.afm.generator_deep import GeneratorDeep
from .._labels import (
    build_label2id,
    get_label_ids,
...
class AFMPipeline(DiffusionPipeline):
  r"""
  Pipeline for adversarial flow model (AFM) sampling with a DiT-based generator.

  This pipeline integrates the AFM `Generator` or `GeneratorDeep` with a VAE and a
  continuous flow-matching scheduler for multi-NFE latent sampling.
  """
  ...
  def __init__(
      self,
      generator: Union[Generator, GeneratorDeep],
      vae,
