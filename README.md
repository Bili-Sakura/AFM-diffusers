...
- **DiT** (AFM): [`DiT-diffusers`](https://github.com/Bili-Sakura/DiT-diffusers) style wrappers on `DiTTransformer2DModel`
- **SiT** (CAFM): [`SiT-diffusers`](https://github.com/Bili-Sakura/SiT-diffusers) native `SiTTransformer2DModel`
...
1. Install requirements: `pip install -r requirements.txt` or `pip install -e .`.
...
4. Download pre-trained checkpoints.
    ...
    * Download [Z-Image](https://huggingface.co/Tongyi-MAI/Z-Image) and place it under root directory as `/Z-Image`.
